		...
		<div>
			<form class="settings-form" action="/" method="GET">
				...
				<div>
					...
					<label>Rosnąco: <input name="sortorder" type="radio" value="asc" <?php echo $order === 'asc' ? 'checked' : ''?> ></label> <!-- asc -> ascending -->
					<label>Malejąco: <input name="sortorder" type="radio" value="desc" <?php echo $order === 'desc' ? 'checked' : ''?> ></label> <!-- dsc -> ascending -->
				</div>
				<div>
